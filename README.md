...
2. GET Single User (store email into Global Variable): Retrieves a single user and saves the email to a Global Variable
3. PUT Update User: Updates user data
4. POST Register Successful (email taken from GET Single User response): Register using the email obtained from the previous scenario
